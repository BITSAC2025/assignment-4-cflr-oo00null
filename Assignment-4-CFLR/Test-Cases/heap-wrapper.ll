; ModuleID = 'Assignment-4-CFLR/Test-Cases/heap-wrapper.c'
source_filename = "Assignment-4-CFLR/Test-Cases/heap-wrapper.c"
...
entry:
  ...
  %call = call ptr @my_alloc()
  store ptr %call, ptr %o1, align 8
  %call1 = call ptr @my_alloc()
