; ModuleID = 'Assignment-4-CFLR/Test-Cases/ptr-dereference1.c'
source_filename = "Assignment-4-CFLR/Test-Cases/ptr-dereference1.c"
...
entry:
  ...
  call void @MUSTALIAS(ptr noundef %0, ptr noundef %1)
  store ptr %b, ptr %c, align 8
  %2 = load ptr, ptr %c, align 8
  %3 = load ptr, ptr %d, align 8
  call void @MAYALIAS(ptr noundef %2, ptr noundef %3)
  %4 = load ptr, ptr %d, align 8
  call void @NOALIAS(ptr noundef %b, ptr noundef %4)
  ret i32 0
}
